        ...
        <WithRightBG imgpathname='/images/registration_img_3.png'>
            ...
            <div className="w-[370x] mx-auto mt-[52px] sm:w-full">
                <div className='text-center'>
                    ...
                    <div className='text-[16px] text-[#828282] font-arial font-[400] mt-[16px] mx-[100px]'>
                        &nbsp;&nbsp;&nbsp; Does the senior require assistance with walking, transfers, or the use of mobility aids (such as a wheelchair, walker, or cane)? Please provide details.
                    </div>
            ...
            <div className='mx-[65px] pl-[40px] mt-5'>
                <div className='mt-5 ml-4 px-7 pb-7'>
                    <InputField type='text' title='List of services required by senior' placholder='Walking, Transfer' value={name} handleChange={setName} />
                    <div className='mt-7'>
                        <InputField type='text' title='List of Mobility aids' placholder='Wheelchair, Cane' value={address}
                            handleChange={setAddress} />
                    </div>
                    <div className='mt-7'>
                        <InputField type='text' title='Note' placholder='Leave a note' value={mail} handleChange={setMail} />
                    </div>
                </div>
            </div>
